...
<div class="my-8 not-prose flex justify-center">
  <a 
    href="https://ubiquitous.udem.edu/~iac-612956/assets/entregas/parcial1/eg/1/main.tar.gz" 
    download
    ...
    <span class="text-xs px-2 py-0.5 rounded bg-slate-800 text-slate-400 border border-slate-700">ZIP</span>
  </a>
</div>
